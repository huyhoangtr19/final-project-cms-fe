...
// node_modules/@vtaits/react-color-picker/dist/esm/index.js
...
var BaseComponent = class extends import_react2.Component {
  constructor() {
    super(...arguments);
    this.hsv = null;
    this.state = baseInitialState;
    this.rootRef = (0, import_react2.createRef)();
...
var HueSpectrum = class extends BaseComponent {
  ...
  getDragPosition() {
    ...
    const computedHeight = height || ((_a = this.rootRef.current) == null ? void 0 : _a.getBoundingClientRect().height);
  ...
  render() {
    ...
    return (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        ref: this.rootRef,
        tabIndex: 0,
        children: (0, import_jsx_runtime.jsx)("div", { className: "react-color-picker__hue-drag", style: dragStyle, children: (0, import_jsx_runtime.jsx)("div", { className: "react-color-picker__hue-inner" }) })
      }
    );
  }
};
...
var SaturationSpectrum = class extends BaseComponent {
  ...
  prepareProps(thisProps) {
    ...
    props.className = (0, import_classnames2.default)(
      thisProps.className,
  ...
  render() {
    ...
    return (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        ...
        tabIndex: 0,
        children: [
          (0, import_jsx_runtime2.jsx)("div", { className: "react-color-picker__saturation-white", children: (0, import_jsx_runtime2.jsx)("div", { className: "react-color-picker__saturation-black" }) }),
          (0, import_jsx_runtime2.jsx)("div", { className: "react-color-picker__saturation-drag", style: dragStyle, children: (0, import_jsx_runtime2.jsx)("div", { className: "react-color-picker__saturation-inner" }) })
        ]
      }
    );
  }
...
var ColorPicker = class extends import_react.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const className = (0, import_classnames.default)(propsClassName, "cp react-color-picker");
    const hueStyle = {
      ...propsHueStyle,
    ...
    return (0, import_jsx_runtime3.jsxs)("div", { ...divProps, className, children: [
      (0, import_jsx_runtime3.jsx)(SaturationSpectrum, { ...saturationConfig }),
      (0, import_jsx_runtime3.jsx)(HueSpectrum, { ...hueConfig })
    ] });
  }
};
